...
cfg.logrotate_m.default_arg.file_path = server_cfg.world.loginserver_2.logpath
cfg.logrotate_m.default_arg.sys_cmd = [[
	/usr/bin/pkill -HUP -f skynet.make/loginserver_config.lua.load_mods_prod_2.lua\n
]]
