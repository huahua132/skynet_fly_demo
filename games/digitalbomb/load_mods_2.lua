...
cfg.share_config_m.default_arg.cluster_server = cluster_server_cfg.games.digitalbomb_2
cfg.share_config_m.default_arg.server_cfg = server_cfg.games.digitalbomb_2
cfg.share_config_m.default_arg.room_game_login.gateconf = gate_cfg.games.digitalbomb_2

cfg.logrotate_m.default_arg.file_path = './logs_2/'
cfg.logrotate_m.default_arg.sys_cmd = [[
	/usr/bin/pkill -HUP -f skynet.digitalbomb_config.lua.load_mods_2.lua\n
]]
