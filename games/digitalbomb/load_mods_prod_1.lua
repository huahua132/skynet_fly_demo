...
cfg.share_config_m.default_arg.frpc_server = frpc_server_cfg.games.digitalbomb_1
cfg.share_config_m.default_arg.server_cfg = server_cfg.games.digitalbomb_1
cfg.share_config_m.default_arg.room_game_login.wsgateconf = gate_cfg.games.digitalbomb_1

cfg.logrotate_m.default_arg.file_path = server_cfg.games.digitalbomb_1.logpath
cfg.logrotate_m.default_arg.sys_cmd = [[
	/usr/bin/pkill -HUP -f skynet.make/digitalbomb_config.lua.load_mods_prod_1.lua\n
]]
