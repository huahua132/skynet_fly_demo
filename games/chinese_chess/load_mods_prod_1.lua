...
cfg.share_config_m.default_arg.room_game_login.wsgateconf = gate_cfg.games.chinese_chess_1

cfg.logrotate_m.default_arg.file_path = server_cfg.games.chinese_chess_1.logpath
cfg.logrotate_m.default_arg.sys_cmd = [[
	/usr/bin/pkill -HUP -f skynet.make/chinese_chess_config.lua.load_mods_prod_1.lua\n
]]

cfg.mysql_m.default_arg.instance_name = mysql_cfg.games.chinese_chess_1.database
cfg.mysql_m.default_arg.db_conf = mysql_cfg.games.chinese_chess_1
